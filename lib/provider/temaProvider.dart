//provider que nos servirá como guía para el esquema de colores
//de la app, y que nos permitirá cambiar entre "modo claro"
//y "modo oscuro" la app
...
class TemaProvider with ChangeNotifier {
  ...
  ThemeData _miTemaClaro() {
    return (ThemeData.light().copyWith(
      colorScheme: const ColorScheme(
        primary: Colors.green, // Azul primario
        secondary: Colors.lightGreen, // Color secundario
  ...
  ThemeData _miTemaOscuro() {
    return (ThemeData.dark().copyWith(
      colorScheme: const ColorScheme(
        primary: Colors.green, // Azul primario para el tema oscuro
        secondary: Colors.lightGreen, // Color secundario para el tema oscuro
        background: Color(0xFF121212), // Color de fondo para el tema oscuro
        surface:
            Color(0xFF1E1E1E), // Color de la superficie para el tema oscuro
        onPrimary: Colors
            .white, // Color del texto sobre el color primario en el tema oscuro
        onSecondary: Colors
            .black, // Color del texto sobre el color secundario en el tema oscuro
        onBackground:
            Colors.white, // Color del texto sobre el fondo en el tema oscuro
        onSurface: Colors
            .white, // Color del texto sobre la superficie en el tema oscuro
